...
public class EquipmentsService : IEquipmentsService
{
    ...
    public EquipmentsService(IEntitiesRepository entitiesRepository, IMapper mapper, JwtHelper jwtHelper, ITransactionsRepository transactionsRepository, ITransactionTypesRepository transactionTypesRepository, ILogger<EquipmentsService> logger)
    {
